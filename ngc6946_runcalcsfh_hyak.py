...
p much the same as the astro machine one except this is set up for how I have things in hyak
example on how to run: 
python ngc6946_runcalcsfh_hyak.py 2265 /gscratch/astro/detran/MATCH/NGC6946 Padua2006_CO_AGB pattern 0.8 0.0 0.2 0.2 0.05 0.05
...
def calcsfh(photfile, fakefile, IMF, dmod, Av, res, logZ,
    ...
    calcsfh = '/gscratch/astro/mlazz/match2.7/bin/calcsfh' #Edit 20220615: Updated path to Margaret's hyak MATCH installation
...
def main():
    ...
    #print('cwd =',os.getcwd())
    # Path constants\
    #proj_dir = '/gscratch/astro/detran/MATCH/NGC6946/'
...
#       if needed.
    ...
    if sys.argv[3] == 'Padua2006_CO_AGB':
        ...
        logZ = (-2.3, 0.2, 0.1) #use Padua range as default
    BF = 0.35
    badfrac = (1e-6, 1e-6)
